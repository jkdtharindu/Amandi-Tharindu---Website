...
8. Security & production readiness (Model: Opus 5) — **partially done 2026-09-05**, split below.
   ...
   - [ ] Still unported from `archive/claude/mobile-only-session-qj1ixz-2026-09-04`: the request-logging/sanitization middleware (`src/request-logger.js`). That branch's RLS-policy migration and admin-auth scaffolding remain NOT reusable as-is — see MEMORY.md 2026-09-04 "Abandoned Branches". (Model: Opus 5)
