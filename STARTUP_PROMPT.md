...
- **Referenced but not on `main`:** `docs/VIBE_CODING_PRODUCTION_CHECKLIST.md` lives only on unmerged PR #6 (`claude/vibe-coding-checklist-markdown-h3cvo7`). TASKS.md Next Action 8 cites its project-tier table. That branch is stale — its copy of Action 8 predates the 2026-09-06 security work and would revert it if merged as-is — and its PR description claims a MEMORY.md entry it does not contain. See MEMORY.md 2026-09-06.
